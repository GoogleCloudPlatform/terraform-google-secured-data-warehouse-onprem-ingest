...
variable "service_account_users" {
  description = "The email address of the service accounts, groups, or users that will need role 'serviceAccountUser' on the dataflow and cloud function service accounts."
  type        = map(string)
}
