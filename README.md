...
| database\_type | Type of database where the data will be persisted. Available values are: "POSTGRES", "BIG\_QUERY". | `string` | `"BIG_QUERY"` | no |
...
| postgresql | PostgreSQL configuration. For value details check: <https://registry.terraform.io/modules/terraform-google-modules/sql-db/google/latest/submodules/postgresql>. | <pre>object(<br>    {<br>      version                         = string<br>      maintenance_version             = optional(string, null)<br>      deletion_protection_enabled     = optional(bool, true)<br>      machine_type                    = string<br>      tier                            = optional(string, null)<br>      availability_type               = optional(string, null)<br>      maintenance_version             = optional(string, null)<br>      maintenance_window_day          = optional(string, null)<br>      maintenance_window_hour         = optional(string, null)<br>      maintenance_window_update_track = optional(string, null)<br>      database_flags = optional(<br>        list(<br>          object(<br>            {<br>              name  = string<br>              value = string<br>            }<br>          )<br>        ),<br>        []<br>      )<br>    }<br>  )</pre> | `null` | no |
